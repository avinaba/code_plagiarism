...
complex_var mult_complex_var(complex_var c);//mult_complex_variplication: z1. z2 = (x1x2 - y1y2) + i(x1y2 + x2y1)
...
complex_var complex_var::mult_complex_var(complex_var c){//real = x1, y1 = imag  c.real = x2, c.imag = y2
complex_var mult_complex_var;//mult_complex_variplication: z1. z2 = (x1x2 - y1y2) + i(x1y2 + x2y1)
...
complex_var div_complex_var;//a=real,b=imag,c=c.real,d=c.imag
